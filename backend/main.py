...
from backend.routers.descriptions import router as descriptions_router
...
app = FastAPI(title="PrintFlow-3D", version="1.15.1")
...
def on_startup():
    init_db()
    log_business("服务启动", "PrintFlow-3D", version="1.15.1")
